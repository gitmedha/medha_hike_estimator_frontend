...
export const incrementValidations = Yup.object().shape({
    appraisal_cycle: Yup.string().required('Appraisal cycle is required'),
    average: Yup.number()
    ...
    current_salary: Yup.string()
      .required('Current salary is required'),
    employee_id: Yup.string().required('Employee ID is required'),
    full_name: Yup.string().required('Full name is required'),
    inc_adjustments: Yup.string()
      .matches(/^\d+%$/, 'Incremental adjustments must be a percentage')
